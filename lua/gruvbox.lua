...
local function get_groups()
    ...
    local groups = {
        ...
        GruvboxRedUnderlineStraight = { underline = config.underline, sp = colors.red },
        GruvboxGreenUnderlineStraight = { underline = config.underline, sp = colors.green },
        GruvboxYellowUnderlineStraight = { underline = config.underline, sp = colors.yellow },
        GruvboxBlueUnderlineStraight = { underline = config.underline, sp = colors.blue },
        GruvboxPurpleUnderlineStraight = { underline = config.underline, sp = colors.purple },
        GruvboxAquaUnderlineStraight = { underline = config.underline, sp = colors.aqua },
        GruvboxOrangeUnderlineStraight = { underline = config.underline, sp = colors.orange },
        GruvboxWhiteUnderlineStraight = { underline = config.underline, sp = colors.fg1 },
        GruvboxUnderlineStraight = { underline = config.underline },

        CursorWordColor = { underline = config.underline, sp = colors.fg1 },
        ...
        IlluminatedWordText = { link = "GruvboxUnderlineStraight" },
        IlluminatedWordRead = { link = "GruvboxUnderlineStraight" },
        IlluminatedWordWrite = { link = "GruvboxUnderlineStraight" },
